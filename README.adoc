...
== Let's get started
In this section we will be following the steps as defined in the Overview section. The steps can be followed an executed as individual pieces or you cna run the full `Forge` script script availabel wsfk-hol.fsh[here].
